...
class ModelPurchaseChart extends Model {
	...
	public function getPurchaseChartData()
	{
        ...
        ON (".DB_PREFIX."po_order.id = ".DB_PREFIX."po_product.order_id) WHERE receive_bit = 1 AND delete_bit = 1;");
	...
	public function getPurchaseChartFilterData($data)
	{
		...
		".DB_PREFIX."po_order
			INNER JOIN ".DB_PREFIX."po_product 
        ON (".DB_PREFIX."po_order.id = ".DB_PREFIX."po_product.order_id) WHERE receive_bit = 1 AND delete_bit = 1 AND receive_date BETWEEN '".$data['date_start']."' AND '".$data['date_end']."'");
