	  ...
	  <form action="<?php echo $filter;?>" method="post" enctype="multipart/form-data" id="form-filter">
        <div class="well">
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-date-added"><?php echo $field_order_id; ?></label>
                <input type="text" name="filter_id" value="<?php if(isset($filter_id)){ echo $filter_id; }?>" placeholder="<?php echo $field_order_id; ?>" id="input-id" class="form-control" />
			  </div>
			</div>
			  <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="status"><?php echo $field_status; ?></label>
		  ...
		  <div class="row">
			<div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-date-start"><?php echo $field_from; ?></label>
                <div class="input-group date">
                  <input onkeypress="return false" type="text" name="from" value="<?php if(isset($from)) { echo $from; }?>" placeholder="<?php echo $field_from; ?>" data-date-format="YYYY-MM-DD" id="input-date-start" class="form-control" />
                  <span class="input-group-btn">
			...
			<div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-date-end"><?php echo $field_to; ?></label>
                <div class="input-group date">
                  <input onkeypress="return false;" type="text" name="to" value="<?php if(isset($to)) { echo $to; }?>" placeholder="<?php echo $field_to; ?>" data-date-format="YYYY-MM-DD" id="input-date-end" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
		  ...
		  <div class="row">
				<div class="col-sm-12">
					<button class="btn btn-primary pull-right" id="clear-filter" onclick="reset_form();" type="button"><?php echo $button_clear; ?></button>
					<button class="btn btn-primary pull-right" id="button-filter" style="margin-right:10px;" type="submit"><i class="fa fa-search"></i><?php echo $button_filter; ?></button>
				</div>
		  </div>
        </div>
		</form>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left"><?php echo $column_order_by; ?></td>
              ...
              <tbody>
				...
				?>
						<tr>
                            ...
                            <td class="text-left"><a class="btn btn-info" href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="view" class="btn btn-primary"><i class="fa fa-eye"></i></a><a href="<?php echo $receive . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="<?php echo "Receive Order"; ?>" style="margin-left: 5px;" class="btn btn-info <?php echo $order['receive_bit']==1?'disabled':''; ?>" ><i class="fa fa-truck"></i></a></td>
						</tr>
				<?php
					}
				}?>
