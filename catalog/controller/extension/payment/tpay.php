...
class ControllerExtensionPaymentTpay extends Controller {
    ...
    public function index() {
        ...
        $data['tpay_form'] = static::parseTemplate('bankSelection', $data);
    ...
    private static function parseTemplate($templateFileName, $data = array())
    {
        $templateDirectory = DIR_SYSTEM . 'library/tpayLibs/src/common/_tpl/';
        $buffer = false;
